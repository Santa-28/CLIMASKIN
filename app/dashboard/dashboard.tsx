...
// import { View, ScrollView, Text, StyleSheet, FlatList, TextInput, TouchableOpacity, Dimensions } from "react-native";
...
//     <TabBar
//       {...props}
//       renderIcon={({ route, focused, color }: { route: { key: string; title: string }; focused: boolean; color: string }) => {
